...
import com.tradexl.loadmoredata.network.MoviesApi;
import com.tradexl.loadmoredata.network.ServiceGenerator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadMore(int index){
        ...
        Call<List<MovieModel>> call = api.getMovies(index);
        Log.d(TAG,api.getMovies(index).request().url().toString());
        call.enqueue(new Callback<List<MovieModel>>() {
            @Override
            public void onResponse(Call<List<MovieModel>> call, Response<List<MovieModel>> response) {
                if(response.isSuccessful()){
